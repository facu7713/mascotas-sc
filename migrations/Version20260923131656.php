 ...
 */
final class Version20260923131656 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE mascota (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(100) NOT NULL, tipo VARCHAR(50) NOT NULL, color VARCHAR(50) NOT NULL, genero VARCHAR(20) NOT NULL, foto VARCHAR(255) NOT NULL, codigo_qr VARCHAR(255) DEFAULT NULL, estado VARCHAR(30) NOT NULL, user_id INT NOT NULL, tarjeta_id_id INT NOT NULL, INDEX IDX_11298D77A76ED395 (user_id), UNIQUE INDEX UNIQ_11298D77F1D4C0C4 (tarjeta_id_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
